            ...
            {docs.map(doc => (
              <div key={doc._id} className="doc-card">
                ...
                <div className="doc-actions">
                  <a href={`/uploads/${doc.filename}`} target="_blank" rel="noreferrer" className="btn btn-secondary btn-sm" style={{ flex:1, justifyContent:'center' }}>👁 Preview</a>
                  <a href={`/uploads/${doc.filename}`} download={doc.originalName||doc.name} className="btn btn-secondary btn-sm" style={{ flex:1, justifyContent:'center' }}>↓ Download</a>
                </div>
              </div>
            ))}
          </div>
